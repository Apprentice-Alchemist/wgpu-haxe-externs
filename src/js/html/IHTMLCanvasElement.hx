...
typedef IHTMLCanvasElement = {
	...
	**/
	@:overload(function(contextId:String, ?options:ImageBitmapRenderingContextSettings):Null<js.html.ImageBitmapRenderingContext> { })
	@:overload(function(contextId:String, ?options:WebGLContextAttributes):Null<js.html.webgl.RenderingContext> { })
	@:overload(function(contextId:String, ?options:WebGLContextAttributes):Null<js.html.webgl.WebGL2RenderingContext> { })
	@:overload(function(contextId:String, ?options:Dynamic):Null<RenderingContext> { })
	@:overload(function(contextId:String):Null<wgpu.IGPUPresentationContext & wgpu.IGPUCanvasContext> { })
	function getContext(contextId:String, ?options:CanvasRenderingContext2DSettings):Null<js.html.CanvasRenderingContext2D>;
	function toBlob(callback:BlobCallback, ?type:String, ?quality:Dynamic):Void;
	/**
	...
	**/
	...
	@:optional
	dynamic function onloadend(ev:ProgressEvent<js.html.EventTarget>):Dynamic;
	/**
	...
	**/
	@:optional
	dynamic function onprogress(ev:ProgressEvent<js.html.EventTarget>):Dynamic;
	/**
