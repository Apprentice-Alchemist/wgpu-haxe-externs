...
@:native("OffscreenCanvas") extern class OffscreenCanvas {
	...
	**/
	...
	@:overload(function(contextId:String, ?options:js.html.webgl.ContextAttributes):Null<js.html.webgl.RenderingContext> { })
	@:overload(function(contextId:String, ?options:js.html.webgl.ContextAttributes):Null<js.html.webgl.WebGL2RenderingContext> { })
	...
	**/
	...
	static var prototype : OffscreenCanvas;
}